 ...
 *      CRC16_USE_TABLE -> to compile functions that use a lookup table.
 *      undefine CRC16_USE_TABLE  -> to compile funciton that calculates crc bitwise.
 *      
 ...
 *
 * To compile the static versions of the function please define CRC16_MASK and CRC16_INIT with option -D of the gcc compiler, or with defines.
 */
#ifndef CRC16_H
#define CRC16_H
...
#include <stdint.h>
   ...
   * \note to activate this undefine CRC16_USE_TABLE, CRC16_MASK=mask and CRC16_INIT=init with compiler's -D option.
   ...
   * \note to activate this define USEBIT, CRC16_MASK=mask and CRC16_INIT=init with compiler's -D option.
